...
public abstract class AbstractDAO<T,U> {
	...
	public  List<Object[]> getArrayListByCriteria(U criteria, int firstResult,
			...
			String... fieldsToLoad) 
	{
		return (List<Object[]>)getListByCriteria(criteria, firstResult, maxResult, orderBy, distinct, joinTableWithFieldsToLoad, Object[].class, fieldsToLoad);
	}
	
	@SuppressWarnings("unchecked")
	public  List<T> getListByCriteria(U criteria, int firstResult,
			int maxResult, Map<String, Boolean> orderBy, boolean distinct,
			Map<String, Set<String>> joinTableWithFieldsToLoad,
			String... fieldsToLoad)
	{
		return (List<T>)getListByCriteria(criteria, firstResult, maxResult, orderBy, distinct, joinTableWithFieldsToLoad, getEntityClazz(), fieldsToLoad);
	}
	...
	public  List<T> getListByCriteria(U criteria, int firstResult,
			int maxResult)
	{
		return (List<T>)getListByCriteria(criteria, firstResult, maxResult, null, false, null, getEntityClazz());
	}

	
	public  List<?> getListByCriteria(U criteria, int firstResult,
			int maxResult, Map<String, Boolean> orderBy, boolean distinct,
			Map<String, Set<String>> joinTableWithFieldsToLoad,Class<?> resultType,
			String... fieldsToLoad) {
		CriteriaBuilder cb = getEntityManager().getCriteriaBuilder();
		...
		Predicate[] array = new Predicate[predicates.size()];
		array = predicates.toArray(array);
		cq.where(cb.and(getSearchPredicates(r, criteria)));
